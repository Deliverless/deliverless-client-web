...
const routes = [
  ...
  { path: "/logout/customer", element: <Logout redirectTo="/login"></Logout> },
  { path: "/logout/restaurant", element: <Logout redirectTo="/restaurant/login"></Logout> },
  { path: "/logout/driver", element: <Logout redirectTo="/driver/login"></Logout> },
...
const appBarLinks = [
  ...
  { title: 'Logout', icon: 'sign-out', url: "/logout/customer", role: 'customer', isAuth: true },
  { title: 'Logout', icon: 'sign-out', url: "/logout/restaurant", role: 'restaurant', isAuth: true },
  { title: 'Logout', icon: 'sign-out', url: "/logout/driver", role: 'driver', isAuth: true },
