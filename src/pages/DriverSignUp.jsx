        ...
        <div>
          ...
          {activeStep === 1 && (
            <div
              ...
              style={{ textAlign: "center", flexDirection: "column" }}
            >
              <h2 style={{ marginBottom: "40px" }}>Vehicle Details</h2>
                ...
                <CardContent>
                  ...
                  >
                    ...
                    <ul>
                      ...
                      <li>
                        <p>
                          ...
                          refers to [___COMPANY_INFORMATION___].
                        </p>
                      </li>
                      <li>
                        <p>
                      ...
                      <li>
                        <p>
                          ...
                          innovations or suggestions sent by You regarding the
                    ...
                    <p>
                      ...
                      the manner of any Content. The Company can also limit or
                    ...
                    <p>
                      ...
                      agent via email ([___COPYRIGHT_AGENT_CONTACT_EMAIL___])
                    ...
                    <p>
                      ...
                      notification, the Company will take whatever action, in
                      its sole discretion, it deems appropriate, including
